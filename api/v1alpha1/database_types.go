...
type DatabaseSpec struct {
	...
	// name of the database. If not exists, it will be created.
	// +required
	Name string `json:"name"`

	// schema of the database. If not exists, it will be created.
	// +required
	Schema string `json:"schema"`

	// encoding of the database. By default, it will be UTF8.
	// +optional
	Encoding string `json:"encoding"`

	// timezone of the database. By default, it will be UTC.
	// +optional
	...
	// database service name. Default is database name
	// +optional
